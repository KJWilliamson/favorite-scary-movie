...
function check() {
  ...
  if (horror === "poltergeist") {
    ...
    document.querySelector("#placeToSee").innerText =
      "He scraped his fingernails along things. Actually, they were more like finger-knives or something, like he’d made them himself.";
    ...
    horror === "people under the stairs"
  ) {
    document.querySelector("#placeToSee").innerText =
      " That brother and sister act you mess with...are evil, plain and simple.";
    ...
    document.querySelector("#placeToSee").innerText =
      "The past will come back to bite you in the ass. Whatever you think you know about the past, forget it. The past is not at rest.";
    ...
    document.querySelector("#placeToSee").innerText =
      "They all believed in different gods, but for that night they were all dealing with the same devil.";

    document.querySelector("body").style.backgroundImage =
      "url('https://pa1.narvii.com/5987/454a0c2ca1428d865b161ce7669964eca8afd5b6_hq.gif')";
  } else if (horror === "audrey rose") {
    document.querySelector("#placeToSee").innerText =
      "You're saying reincarnation. I mean, is that what you're saying?";
    ...
    document.querySelector("#placeToSee").innerText =
      "Back off! Just back off! · Get out of here, you bastard! I'll burn you up!";
    ...
    document.querySelector("#placeToSee").innerText =
      "My God! It's a shark. It's like twenty, twenty-five meters.";
    ...
    document.querySelector("#placeToSee").innerText =
      "Excuse me Dr. Seaton, that little blonde girl keeps staring at the mirror, as if she sees us";

    document.querySelector("body").style.backgroundImage =
      "url('https://64.media.tumblr.com/e514b2340853e1f7eea89c16fedf8b66/tumblr_phd2bi9z0q1qj6sk2o1_500.gifv')";
  } else if (horror === "wolfen") {
    document.querySelector("#placeToSee").innerText =
      "It's not wolves, it's Wolfen. For 20,000 years Wilson - ten times your Christian era - the 'skins and wolves, the great hunting nations, lived together, nature in balance. Then the slaughter came.";
    ...
    document.querySelector("#placeToSee").innerText =
      "I just want to stop whatever is happening. My friends are dying.";
    ...
    document.querySelector("#placeToSee").innerText =
      "I'm so sorry for calling so late. My name is Lorraine. You helped my family a long time ago when my son was just a boy. And now the same thing is happening to my grandson.";
    ...
    document.querySelector("#placeToSee").innerText =
      "It’s all real. The boogeyman is real…and you found him.";
    ...
    document.querySelector("#placeToSee").innerText =
      "No one uses this corridor. People who go in this tunnel don't come out";
    ...
    document.querySelector("#placeToSee").innerText =
      "12 years ago Raymond Garth killed his family here and then committed suicide!";
    ...
    document.querySelector("#placeToSee").innerText =
      "He moves through this town unseen, like a ghost, and he kills at will every year. The geriatric serial killer, really?";

    document.querySelector("body").style.backgroundImage =
      "url('https://c.tenor.com/yGZvVLb5P8kAAAAC/freaky-movie-millie.gif')";
  } else if (horror === "the final girls") {
    document.querySelector("#placeToSee").innerText =
      "At least I get to see her on the anniversary of her death. Even if she is being chased by a psycho";

    document.querySelector("body").style.backgroundImage =
      "url('https://gbhbl.files.wordpress.com/2016/06/gif3434243.gif')";
  } else if (horror === "the faculty") {
    document.querySelector("#placeToSee").innerText =
      "You know in my world Casey, there were limitless oceans as far as the eye could see. Beautiful, huh?";
    ...
    document.querySelector("#placeToSee").innerText =
      "Look i'm sorry, but the game is real, once your asked you're in. Wherever you go, whatever you do it will find you.";
    ...
    horror === "a nightmare on elm street 2" ||
    horror === "nightmare on elm street 2"
  ) {
    document.querySelector("#placeToSee").innerText =
      "Fight it, Jesse! You created him. You can destroy him! He is living off of your fear, Jesse. ";
    ...
    horror === "a nightmare on elm street 3" ||
    horror === "nightmare on elm street 3"
  ) {
    ...
    document.querySelector("#placeToSee").innerText =
      "No. There's no government. No army. No police. No TV, no radio, no electricity. You're the first uninfected person we've seen in six days";
    ...
    document.querySelector("#placeToSee").innerText =
      "You're going to have to stand up for yourself one of these days.";
